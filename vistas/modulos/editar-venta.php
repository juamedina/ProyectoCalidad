              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="hidden" name="idVendedor" value="<?php echo $vendedor["dni"]; ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="nuevoCliente" value="<?php echo $cliente["nombre"]; ?>" readonly>

                    <input type="hidden" name="clienteDocumentoId" value="<?php echo $cliente["dni"]; ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" step="0.1" class="form-control" id="descuento" name="descuento" value="<?php echo $venta["descuento"]; ?>" placeholder="S/. 0.00" 
                    min = "0"
                    />
